...
<h3><?php echo esc_js( $q_sl.". ".$tf_question );?></h3>
<?php if($em_type == "Exam"){ ?><select id="answer<?php echo esc_js( $q_sl); ?>">
                            <option value="True">True</option>
                            <option value="False">False</option>
                         </select><?php } ?>
<?php if($em_type == "Exercise"){ ?>True <br/> False <?php } ?>

<input type="hidden" id="correct_answer<?php echo esc_js( $q_sl);?>" value="<?php echo esc_js( $tf_answer);?>">
<?php if($em_type == "Exam"){ ?>
