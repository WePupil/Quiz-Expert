...
<br/><br/>
Time (minutes):
<input type="text" id="new_em_time" value="<?php echo esc_attr( $em_time);?>">
<br/>
<a id="savecheck" style="color:green"></a><br/><br/>
<input type="button" class="button button-primary" value="Save Settings" onclick="quexp_save_settings_button(<?php echo esc_attr( $em_id);?>);">
</div>
