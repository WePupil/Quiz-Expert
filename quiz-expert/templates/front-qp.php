...
<input type="hidden" id="em_id" value="<?php echo esc_attr( $em_id); ?>">
<input type="hidden" id="em_user_id" value="<?php echo esc_attr( $em_user_id); ?>">
<input type="hidden" id="em_type" value="<?php echo esc_attr( $em_type); ?>">
<input type="hidden" id="em_time" value="<?php echo esc_attr( $em_time); ?>">
</div>
